...
PATH_HISTORICAL  <- "D:/CCR_AOS/ACTIVITES/AGRHYMET/2026/DCEM/PRESASS/data/predictants/subbassins_seasonnal_discharge_lev5_v2.csv" #"data/was_subbassins_seasonal_data.csv" # columns: DATE, HYBAS_ID, Q, prcp, evap
PATH_PREDICTORS  <- "D:/CCR_AOS/ACTIVITES/AGRHYMET/2026/DCEM/PRESASS/data/-60W-60E_to_-25S-25N/SST"
PATH_OUTPUT <- "data/predictors_v2/SST"
